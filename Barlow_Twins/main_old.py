...
parser.add_argument('--print-freq', default=3, type=int, metavar='N',
...
#                 torch.save(state, 'bumpSSL_checkpoint.pth')
                torch.save(model.module.backbone.state_dict(), 'earlystop_512_ori.pth')
